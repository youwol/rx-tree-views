...
export namespace ImmutableTree {
  ...
  export class State<NodeType extends Node> {
    ...
    addChild(
      ...
      if (!parentNode) throw Error("Can not find the parent to add the child");
      ...
      let newChild = new childNode.factory({
        ...childNode,
    ...
    replaceNode(
      ...
      Array.isArray(newNode.children) &&
        newNode.children.forEach((child) => this.setParentRec(child, newNode));
  ...
  export class View<NodeType extends Node> implements VirtualDOM {
    ...
    constructor({
      ...
      let content$ = child$(this.state.root$, (root) => {
      ...
      return isLeaf
        ...
        : {
            ...
            class: attr$(
              nodeExpanded$,
              (expanded) =>
                expanded ? "fa-caret-down fv-tree-expanded" : "fa-caret-right",
